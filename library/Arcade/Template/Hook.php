...
class Arcade_Template_Hook
{
	 ...
	 * @param string $contents	the contents of the template hook block. This content
	 * will be the final rendered output of the block. You should manipulate this,
	 * such as by adding additional output at the end.
	 * @param array $params		explicit key-value params that have been passed to the
	 * hook, enabling content-aware decisions. These will not be all the params that
	 * are available to the template
	 * @param XenForo_Template_Abstract $template	the raw template object that has
	 * called this hook. You can access the template name and full, raw set of
	 * parameters via this object.
	 * @return unknown
	 */
